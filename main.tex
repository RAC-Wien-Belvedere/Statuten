...
a) die Wahl und Enthebung des Vorstandes und die Bestellung der Rechnungsprüfer;
b) die Entscheidung über Aufnahme von ordentlichen Mitgliedern nach Artikel VI Absatz 5 lit b und über den Ausschluss von Mitgliedern; 
c) änderungen und Ergänzungen der Statuten; 
d) die Auflösung des Clubs; 
e) die Entgegennahme und Genehmigung des Jahresberichts des Vorstands und der Jahresabrechnung sowie die Entlastung des Vorstands; 
f) die Festsetzung des Mitgliedsbeitrages für ordentliche und beurlaubte Mitglieder; 
